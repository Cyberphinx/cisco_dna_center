...
def get_commands(
    ...
    """
    Now you have a token so you can use it as a header to make your next
    API call, this time to find out what commands are available using
    GET /v1/network-device-poller/cli/legit-reads. Once you have retrieved
    the JSON data from the response, have your code print the response
    with nice four-space indentation.
    """
